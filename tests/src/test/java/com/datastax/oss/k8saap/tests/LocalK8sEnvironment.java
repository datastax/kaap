...
import static com.datastax.oss.k8saap.tests.BaseK8sEnvTest.OPERATOR_IMAGE;
import static com.datastax.oss.k8saap.tests.BaseK8sEnvTest.PULSAR_IMAGE;
...
public class LocalK8sEnvironment {
    ...
    public static final String NETWORK = "k8saap-local-k3s-network";
    public static final String CONTAINER_NAME = "k8saap-local-k3s";
    ...
    public void mainMulti() throws Exception {
        cleanupOldRuns();
        final Integer agents = Integer.getInteger("k8saap.tests.container.k3s.agents", 1);
        try (
