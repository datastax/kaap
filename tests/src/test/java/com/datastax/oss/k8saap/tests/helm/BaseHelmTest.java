...
import com.datastax.oss.k8saap.tests.BasePulsarClusterTest;
...
public class BaseHelmTest extends BasePulsarClusterTest {
    ...
    public static final String HELM_BIND_PULSAR_OPERATOR = "/helm-k8saap";
    public static final String HELM_BIND_PULSAR_STACK = "/helm-k8saap-stack";
    ...
    public void beforeBaseHelmTest() throws Exception {
        ...
        env.withHelmContainer(helm -> {
            ...
            final Path stackPath = Paths.get("..", "helm", "k8saap-stack");
