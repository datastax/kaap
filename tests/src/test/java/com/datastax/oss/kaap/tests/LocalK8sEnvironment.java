...
import static com.datastax.oss.kaap.tests.BaseK8sEnvTest.OPERATOR_IMAGE;
import static com.datastax.oss.kaap.tests.BaseK8sEnvTest.PULSAR_IMAGE;
import com.dajudge.kindcontainer.K3sContainer;
import com.datastax.oss.kaap.tests.env.k3s.AbstractK3sContainer;
import com.datastax.oss.kaap.tests.env.k3s.MultiNodesK3sContainer;
import com.datastax.oss.kaap.tests.env.k3s.SingleServerK3sContainer;
...
public class LocalK8sEnvironment {
    ...
    public static final String NETWORK = "kaap-local-k3s-network";
    public static final String CONTAINER_NAME = "kaap-local-k3s";
    ...
    public void mainMulti() throws Exception {
        cleanupOldRuns();
        final Integer agents = Integer.getInteger("kaap.tests.container.k3s.agents", 1);
        try (
