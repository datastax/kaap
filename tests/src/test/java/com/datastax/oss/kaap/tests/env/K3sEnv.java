...
import com.datastax.oss.kaap.tests.BaseK8sEnvTest;
...
public class K3sEnv implements K8sEnv {
    ...
    private static final boolean PRELOAD_PULSAR_IMAGE = Boolean
            .parseBoolean(System.getProperty("kaap.tests.operator.image.k3s.preload.pulsar", "true"));
    ...
    private String getTmpKubeConfig() {
        File tmpKubeConfig = Paths.get("/tmp", "kaap-local-k3s-kube-config").toFile();
