...
public class LocalK8sEnvironment extends LocalK3SContainer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (final K3sContainer container = new K3sContainer(k3sImage);){
            createAndMountImageDigest(BaseK8sEnvTest.PULSAR_IMAGE, container);
            createAndMountImageDigest(BaseK8sEnvTest.OPERATOR_IMAGE, container);
            container.start();
            ...
            restoreDockerImageInK3s(BaseK8sEnvTest.PULSAR_IMAGE, container);
            restoreDockerImageInK3s(BaseK8sEnvTest.OPERATOR_IMAGE, container);
